...
export default async function CulturalDistrictDetailPage({
    params,
}: {
    params: Promise<{ slug: string }>
}) {
            ...
            <div className="container mx-auto max-w-7xl px-4 py-6 relative z-20">
                <div className="breadcrumbs text-sm text-base-content/60 font-light">
                    <ul>
                        ...
                        <li><Link href="/cultural-networks/districts" className="hover:text-primary transition-colors">สภาวัฒนธรรมอำเภอ</Link></li>
