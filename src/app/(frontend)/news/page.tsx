            ...
            <section className="container mx-auto max-w-5xl px-4 pb-24 relative z-20">
                <div className="space-y-6 mt-8">
                    {newsItems.length > 0 ? newsItems.map((news: any, i: number) => {
                        ...
                        return (
                            <article key={news.slug || news.id} className={`group bg-white rounded-3xl border border-base-200 shadow-[0_8px_30px_rgb(212,175,55,0.05)] hover:shadow-xl hover:border-secondary/30 transition-all duration-400 overflow-hidden`}>
