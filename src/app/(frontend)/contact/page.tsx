    ...
    return (
        <div className="bg-slate-50 min-h-screen font-sans">
            ...
            <div className="container mx-auto max-w-6xl px-4 py-12 pb-8 relative z-20">
                {/* Contact Cards Grid */}
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-fade-in-up delay-300">
                    {/* Address */}
                    <div className="group relative bg-white rounded-3xl border border-base-200 shadow-sm p-8 hover:border-secondary/30 hover:shadow-[0_8px_30px_rgb(212,175,55,0.08)] transition-all duration-400 overflow-hidden">
                        <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-primary/5 to-transparent rounded-tr-3xl rounded-bl-full opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                        <div className="relative z-10">
                            <div className="w-14 h-14 bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl flex items-center justify-center text-primary mb-6 group-hover:scale-110 transition-transform shadow-sm">
                    ...
                    {/* Phone */}
                    <div className="group relative bg-white rounded-3xl border border-base-200 shadow-sm p-8 hover:border-secondary/30 hover:shadow-[0_8px_30px_rgb(212,175,55,0.08)] transition-all duration-400 overflow-hidden">
                        <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-secondary/5 to-transparent rounded-tr-3xl rounded-bl-full opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                        <div className="relative z-10">
                            <div className="w-14 h-14 bg-gradient-to-br from-secondary/10 to-secondary/5 rounded-2xl flex items-center justify-center text-secondary-dark mb-6 group-hover:scale-110 transition-transform shadow-sm">
                ...
                <div className="mt-12 grid md:grid-cols-2 gap-8 animate-fade-in-up delay-400">
                    {/* Social Media */}
                    ...
                    {/* Quick Access Links */}
                    <div className="bg-gradient-to-br from-primary to-primary-dark rounded-3xl shadow-lg p-8 lg:p-10 text-white relative overflow-hidden">
                        ...
                        <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:40px_40px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_,#000_70%,transparent_100%)]" />
            ...
            <section className="py-20 px-4 md:px-8 bg-white border-t border-base-200 relative overflow-hidden animate-fade-in-up delay-500">
                ...
                <div className="container mx-auto max-w-6xl relative z-10">
                    ...
                    <div className="rounded-3xl border border-secondary/20 shadow-[0_8px_30px_rgb(212,175,55,0.05)] overflow-hidden aspect-video relative">
                        <iframe
