        ...
        <div className="bg-slate-50 min-h-screen font-sans">
            ...
            <div className="container mx-auto max-w-7xl px-4 py-6 relative z-20">
                <div className="breadcrumbs text-sm text-base-content/60 font-light">
                    <ul>
                        ...
                        <li className="text-primary font-medium">ปฏิทินกิจกรรม</li>
                    </ul>
                </div>
            </div>
            ...
            <div className="container mx-auto max-w-7xl px-4 py-8 animate-fade-in-up delay-300">
                <div className="flex flex-wrap gap-3 justify-center md:justify-start items-center mb-6">
                    <Link href="/activities" className="px-6 py-2.5 rounded-full bg-slate-50 border border-base-200 text-base-content/70 text-sm font-medium hover:border-secondary hover:text-primary transition-all">
                        รายการกิจกรรม
                    </Link>
