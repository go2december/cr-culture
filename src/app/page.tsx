                ...
                <div className="container mx-auto max-w-7xl relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            { title: 'ศูนย์เชียงรายศึกษา', icon: <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z" /><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z" /></svg>, desc: 'แหล่งรวบรวมข้อมูล ประวัติศาสตร์ และการศึกษาวิจัยเพื่อการเรียนรู้', color: 'from-[#F5F8FF] to-[#E6EFFF]', borderColor: 'border-primary/20', iconColor: 'text-primary', hoverColor: 'group-hover:bg-primary/10' },
            ...
            <section className="py-32 px-4 md:px-8 bg-slate-50 border-y border-base-200/50 relative overflow-hidden">
                ...
                <div className="container mx-auto max-w-7xl relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            { id: 1, title: 'โครงการสืบสานมรดกภูมิปัญญาท้องถิ่น ประจำปี 2569', desc: 'สภาวัฒนธรรมจังหวัดเชียงรายจัดกิจกรรมส่งเสริมการเรียนรู้และถ่ายทอดภูมิปัญญาจากเครือข่ายศิลปิน', img: 'https://images.unsplash.com/photo-1598911543265-51e8df81c817?q=80&w=800&auto=format&fit=crop' },
                            { id: 2, title: 'เทศกาลโคมล้านนา ประทีปแห่งศรัทธา', desc: 'ร่วมชมความงดงามของการประดับโคมล้านนานับหมื่นดวงทั่วเมืองเชียงราย พร้อมการแสดงศิลปวัฒนธรรม', img: 'https://images.unsplash.com/photo-1605330364239-0f2c00a6e036?q=80&w=800&auto=format&fit=crop' },
                            { id: 3, title: 'นิทรรศการศิลปะผ้าทอพื้นเมืองเชียงราย', desc: 'ชื่นชมลวดลายผ้าทออันเป็นเอกลักษณ์จากกลุ่มทอผ้าพื้นเมืองในพื้นที่ 18 อำเภอ', img: 'https://images.unsplash.com/photo-1622329241517-1f41e5fdf569?q=80&w=800&auto=format&fit=crop' }
                        ].map((item, i) => (
                            <div key={item.id} className={`card-modern bg-white flex flex-col h-full animate-fade-in-up delay-${(i + 1) * 100} group rounded-2xl overflow-hidden shadow-lg shadow-primary/5 hover:shadow-2xl hover:shadow-secondary/10`}>
                                <div className="aspect-[16/10] bg-base-200 relative overflow-hidden flex-shrink-0">
                                    ...
                                    <div className="absolute top-4 left-4 z-20">
                                        <span className="bg-white/90 backdrop-blur-sm text-primary text-xs font-bold px-4 py-2 rounded-full shadow-lg border border-white/20">1{(i + 1)} มี.ค. 2569</span>
                                    </div>
                                </div>
                                <div className="p-8 flex flex-col flex-grow relative bg-white">
                                    ...
                                    <span className="text-xs font-bold tracking-widest text-accent uppercase mb-3 block mt-2">กิจกรรมระดับจังหวัด</span>
                                    ...
                                    <div className="pt-5 border-t border-base-100 flex items-center justify-between mt-auto">
                                        ...
                                        <Link href={`/activities/${item.id}`} className="text-sm font-semibold text-primary hover:text-secondary-dark transition-colors flex items-center gap-1 group/link bg-slate-50 px-3 py-1.5 rounded-full hover:bg-secondary/10">
                                            อ่านต่อ
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5">
                        {[
                            ...
                            >
                                ...
                                <span className="text-base md:text-lg font-medium text-primary/70 group-hover:text-primary transition-colors font-display tracking-wide">{district}</span>
                            </Link>
                        ))}
                    </div>
                </div>
