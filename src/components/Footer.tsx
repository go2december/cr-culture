                ...
                <div className="grid md:grid-cols-4 gap-12">
                    ...
                    <div className="md:col-span-1">
                        ...
                        <div className="flex gap-2">
                            <a href="#" className="w-10 h-10 rounded-full border border-base-200 flex items-center justify-center text-base-content/40 hover:text-primary hover:border-primary/30 hover:bg-primary/5 transition-all">
