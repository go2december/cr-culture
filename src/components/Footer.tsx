            ...
            <div className="container mx-auto max-w-7xl px-4 py-20">
                <div className="grid md:grid-cols-4 gap-12">
                    ...
                    <div className="reveal-soft stagger-2">
                        ...
                        <ul className="space-y-3">
                            <li><Link href="/heritage?category=intangible-heritage" className="text-[15px] text-base-content/60 hover:text-primary transition-colors inline-block font-light">มรดกภูมิปัญญา</Link></li>
                            <li><Link href="/heritage?category=learning-resources" className="text-[15px] text-base-content/60 hover:text-primary transition-colors inline-block font-light">แหล่งเรียนรู้</Link></li>
                            <li><Link href="/heritage?category=local-wisdom" className="text-[15px] text-base-content/60 hover:text-primary transition-colors inline-block font-light">ปราชญ์ชาวบ้าน</Link></li>
