$filePath = "e:\web2026\CR-Culture\src\app\(frontend)\heritage\[slug]\page.tsx"
$content = Get-Content $filePath -Raw

# Replace the share section
$oldPattern = '<div className="mt-12 pt-8 border-t border-base-100 flex flex-col sm:flex-row items-center justify-between gap-4">\s*<h4 className="font-semibold text-base-content/80">แชร์บทความนี้</h4>\s*<div className="flex gap-2">'
$newContent = '<div className="mt-12 pt-8 border-t border-base-100">
