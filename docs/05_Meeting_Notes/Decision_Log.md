...
## Decision: Adjust Navbar Order and Rename Honor Award Categories
- **Date**: 2026-06-30
- **Status**: Accepted
...
### Context
- ต้องการปรับปรุงลำดับการแสดงผลของกลุ่มเมนู "รางวัลเกียรติยศ" ใน Navbar
- ต้องการปรับแต่งการใช้คำเรียกรางวัลเกียรติยศเพื่อความเหมาะสมเชิงวัฒนธรรมและถูกต้อง โดยการเปลี่ยน "ครูภูมิปัญญาเมืองเชียงราย" เป็น "ครูภูมิผญาเมืองเชียงราย" และเปลี่ยน "เยาวชนวัฒนธรรม" เป็น "ยุวชนวัฒนธรรม" ทั่วทั้งโครงการ

### Decision
- ปรับลำดับของกลุ่มเมนูรางวัลเกียรติยศใน Navbar เป็น: 1. คนดีศรีเชียงราย, 2. ครูภูมิผญาเมืองเชียงราย, 3. ยุวชนวัฒนธรรม
- ทำการแทนที่คำเดิมด้วยคำใหม่ ทั่วทั้งโปรเจกต์ ทั้งฝั่งการจัดเก็บข้อมูล CMS และหน้าแสดงผลหลัก แต่ให้คง slugs และ collection properties ในซอร์สโค้ดเดิมเพื่อรักษาความสอดคล้องกับฟิลด์และสคีมาฐานข้อมูลไว้โดยไม่ก่อให้เกิดการเสียหายของข้อมูลความสัมพันธ์

### Consequences
- Positive:
  - ได้คำเรียกรางวัลเกียรติยศที่ถูกต้อง เหมาะสม และตรงตามความต้องการของสภาวัฒนธรรม
  - การใช้งานร่วมกับ CMS และฐานข้อมูลมีความเสถียร ไม่พังจากการเปลี่ยนชื่อ slugs หรือฟิลด์
- Trade-offs:
  - ชื่อ slugs (เช่น `youth-culture`, `wisdom-awards`) ในซอร์สโค้ดกับคำภาษาไทยไม่สอดคล้องกันโดยสมบูรณ์ แต่ได้รับการปกป้องจาก database schema breakage
